...
Here is integrated almost everything from the [PHP QA Tools project][phpqatools], over the [Phing build system][phing].
...
It'll be sufficient for you to get an idea about the state of your codebase.
...
All of the code by default is licensed by [BSD license][bsd-license].
